...
class Motor():
    def __init__(self):
        ...
        self.sub_on = rospy.Service('motor_on', Trigger, self.callback_on)
        self.sub_off = rospy.Service('motor_off', Trigger, self.callback_off)
    ...
    def onoff_response(self, onoff):
        d = TriggerResponse()
        d.success = sel.set_power(onoff)
        d.message = "ON" if self.is_on "OFF"
        return d
